...
export const visiMisiBansos: VisiMisi = {
  ...
  uuList: [
    {
      nomor: 'Undang-Undang Nomor 11 Tahun 2009',
      tentang: 'Kesejahteraan Sosial',
      deskripsi: 'Menjadi landasan hukum utama negara dalam penyelenggaraan kesejahteraan sosial bagi masyarakat miskin dan rentan untuk menjamin kehidupan yang layak dan berkeadilan.'
    },
    {
      nomor: 'Undang-Undang Nomor 13 Tahun 2011',
      tentang: 'Penanganan Fakir Miskin',
      deskripsi: 'Mengatur penetapan kriteria, pendataan terpadu (DTKS), verifikasi dan validasi, serta jaminan pemenuhan kebutuhan dasar pangan, kesehatan, dan pendidikan.'
    },
    {
      nomor: 'Undang-Undang Nomor 14 Tahun 2008',
      tentang: 'Keterbukaan Informasi Publik (KIP)',
      deskripsi: 'Menjamin hak warga negara untuk mengakses informasi publik secara transparan terkait program dan alokasi dana bantuan sosial nasional.'
    },
    {
      nomor: 'Peraturan Presiden Nomor 63 Tahun 2017',
      tentang: 'Penyaluran Bantuan Sosial Secara Non Tunai',
      deskripsi: 'Landasan regulasi penyaluran bansos yang efektif, efisien, akuntabel, dan tepat sasaran melalui akun perbankan / Kartu Keluarga Sejahtera (KKS).'
    },
    {
      nomor: 'Peraturan Menteri Sosial Nomor 3 Tahun 2021',
      tentang: 'Pengelolaan Data Terpadu Kesejahteraan Sosial (DTKS)',
      deskripsi: 'Pedoman teknis pengelolaan, verifikasi berkala, dan pembaruan data KPM untuk menjamin kelayakan penerima bansos nasional.'
    }
  ]
};
